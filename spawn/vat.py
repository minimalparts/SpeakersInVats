...
from utils import read_external_vectors,ppmi,normalise_l2,compute_PCA,print_matrix, print_vocab, print_dict, print_list
...
def mk_vat(args,vocab,speakers,all_ref_to_test,all_test_men,vat_dir):
...
def make_speaker(m,vocab,dim,pert,param):
    ...
    return test_speaker_proc, ref_to_test, sp1_men, sp2_men
...
if __name__=="__main__":
    ...
    for i in range(int(args["--num_speakers"])):
        ...
        ref_speaker = np.copy(m)
        test_speaker, ref_to_test, sp1_men, sp2_men = make_speaker(ref_speaker,vocab,dimensionality,pert,param)
    ...
    mk_vat(args,vocab,speakers,all_ref_to_test,all_sp2_men,vat_dir)
